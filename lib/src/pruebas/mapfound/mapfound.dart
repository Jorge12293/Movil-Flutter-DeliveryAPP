...
LatLng _initialPositon = LatLng(-2.89741, -79.0045) ;
...
//https://www.youtube.com/watch?v=d0GvJeySUdk
class Mapfound extends StatefulWidget {
  @override
  _MapfoundState createState() => _MapfoundState();
}

class _MapfoundState extends State<Mapfound> {
  ...
  final geoMethods = GeoMethods(
    ...
    googleApiKey: 'AIzaSyB1kNvTQdDs4Jq22bVONbjvXlzTT0zHtHo',
    language: 'es-419',
    countryCode: 'ec',
  );
